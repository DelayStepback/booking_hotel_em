...
/// @nodoc
abstract class _$$_AboutHotelModelCopyWith<$Res>
    implements $AboutHotelModelCopyWith<$Res> {
  factory _$$_AboutHotelModelCopyWith(
          _$_AboutHotelModel value, $Res Function(_$_AboutHotelModel) then) =
      __$$_AboutHotelModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String? description, List<String>? peculiarities});
}
...
/// @nodoc
class __$$_AboutHotelModelCopyWithImpl<$Res>
    extends _$AboutHotelModelCopyWithImpl<$Res, _$_AboutHotelModel>
    implements _$$_AboutHotelModelCopyWith<$Res> {
  __$$_AboutHotelModelCopyWithImpl(
      _$_AboutHotelModel _value, $Res Function(_$_AboutHotelModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_AboutHotelModel(
      description: freezed == description
          ? _value.description
          : description // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_AboutHotelModel implements _AboutHotelModel {
  _$_AboutHotelModel(
      {required this.description, required final List<String>? peculiarities})
      : _peculiarities = peculiarities;

  factory _$_AboutHotelModel.fromJson(Map<String, dynamic> json) =>
      _$$_AboutHotelModelFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_AboutHotelModelCopyWith<_$_AboutHotelModel> get copyWith =>
      __$$_AboutHotelModelCopyWithImpl<_$_AboutHotelModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_AboutHotelModelToJson(
      this,
    );
  }
}
...
abstract class _AboutHotelModel implements AboutHotelModel {
  factory _AboutHotelModel(
      ...
      required final List<String>? peculiarities}) = _$_AboutHotelModel;

  factory _AboutHotelModel.fromJson(Map<String, dynamic> json) =
      _$_AboutHotelModel.fromJson;
